export const onlineLevelCourses = [
	{
		slug: 'b1-almanca-kursu', level: 'B1', title: 'Almanca B1 Kursu',
		headline: 'B1 Almanca Kursu – Bağımsız ve Akıcı İletişime Geçin',
		lead: 'Günlük yaşamda, eğitimde ve iş ortamında Almancayı daha bağımsız kullanmaya başlayın.',
		paragraphs: [
		...
		sections: [
			...
			{ title: 'Kimler Katılabilir?', items: ['A2 seviyesini tamamlayan yetişkinler', 'Almancayı günlük hayatta bağımsız kullanmak isteyenler', 'B1 sertifika sınavına hazırlananlar', 'Almanya’da eğitim veya çalışma hedefleyenler'] },
		],
	},
	{
		slug: 'b2-almanca-kursu', level: 'B2', title: 'Almanca B2 Kursu',
		headline: 'B2 Almanca Kursu – Akıcı, Ayrıntılı ve Profesyonel İletişim',
		lead: 'Karmaşık konuları anlayın, fikirlerinizi güçlü biçimde savunun ve Almancayı profesyonel ortamlarda kullanın.',
		paragraphs: [
		...
		sections: [
			...
			{ title: 'Kimler Katılabilir?', items: ['B1 seviyesini tamamlayan yetişkinler', 'İş ve eğitim hayatında Almanca kullanacak olanlar', 'B2 sertifikası hedefleyenler', 'Akıcı konuşma ve yazma becerisi geliştirmek isteyenler'] },
		],
	},
	{
		slug: 'c1-almanca-kursu', level: 'C1', title: 'Almanca C1 Kursu',
		headline: 'C1 Almanca Kursu – Akademik ve Profesyonel Dil Hakimiyeti',
		lead: 'Almancayı karmaşık akademik, mesleki ve sosyal bağlamlarda esnek ve etkili biçimde kullanın.',
		paragraphs: [
		...
		sections: [
			...
			{ title: 'Kimler Katılabilir?', items: ['B2 seviyesini tamamlayan yetişkinler', 'Almanya’da üniversite veya akademik kariyer hedefleyenler', 'Profesyonel düzeyde Almanca kullananlar', 'C1 sertifikası almak isteyenler'] },
		],
	},
];
...
export const examPrepCourses = [
	...
	},
	{
		...
		sections: [
			...
			{ title: 'Çalışma Alanları', items: ['Okuduğunu ve dinlediğini anlama', 'Yapılandırılmış metin üretme', 'Sözlü iletişim ve sunum', 'Deneme sınavları ve hata analizi'] },
			{ title: 'Kimler Katılabilir?', items: ['DSD 1 sınavına hazırlanan öğrenciler', 'B1 düzeyinde sertifika hedefleyenler', 'Yazma ve konuşma pratiğini geliştirmek isteyenler'] },
		],
	},
	{
		slug: 'dsd-2-hazirlik', level: 'DSD 2', title: 'DSD 2 Hazırlık', parentLabel: 'Sınav Hazırlığı', parentHref: '/sinav-hazirligi',
		...
		sections: [
			...
			{ title: 'Çalışma Alanları', items: ['Akademik okuma ve dinleme', 'Grafik ve kaynak destekli metin yazma', 'Proje sunumu ve tartışma', 'Zaman yönetimi ve deneme analizi'] },
			{ title: 'Kimler Katılabilir?', items: ['DSD 2 sınavına hazırlanan lise öğrencileri', 'Almanya’da üniversite hedefleyenler', 'B2 veya C1 düzeyinde akademik Almanca geliştirmek isteyenler'] },
		],
	},
	{
		slug: 'testdaf-hazirlik', level: 'TestDaF', title: 'TestDaF Hazırlık', parentLabel: 'Sınav Hazırlığı', parentHref: '/sinav-hazirligi',
		...
		sections: [
			...
			{ title: 'Çalışma Alanları', items: ['Akademik okuma ve dinleme', 'Grafik yorumlama ve metin üretme', 'Sözlü ifade görevleri', 'Tam deneme ve performans analizi'] },
			{ title: 'Kimler Katılabilir?', items: ['B2-C1 Almanca seviyesindeki katılımcılar', 'Almanya’da üniversite okumak isteyenler', 'TestDaF sonucunu yükseltmeyi hedefleyenler'] },
		],
	},
	{
		slug: 'abitur-hazirlik', level: 'Abitur', title: 'Abitur Hazırlık', parentLabel: 'Sınav Hazırlığı', parentHref: '/sinav-hazirligi',
		...
		sections: [
			...
			{ title: 'Çalışma Alanları', items: ['Eser ve dönem incelemeleri', 'Metin analizi ve yorumlama', 'Kompozisyon ve argümantasyon', 'Deneme yazıları ve ayrıntılı düzeltme'] },
			{ title: 'Kimler Katılabilir?', items: ['Abitur sınavına hazırlanan lise öğrencileri', 'Almanca edebiyat ve yazma desteği arayanlar', 'Sınav performansını geliştirmek isteyenler'] },
		],
	},
];
